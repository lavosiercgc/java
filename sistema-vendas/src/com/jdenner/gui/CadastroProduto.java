...
public class CadastroProduto extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        pnForm.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createEmptyBorder(5, 0, 5, 0), javax.swing.BorderFactory.createTitledBorder(null, "FormulÃ¡rio", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(102, 153, 255)))); // NOI18N
    ...
    private boolean validarFormulario() {
        ...
        if (((Double) ftfPrecoCompra.getValue()) <= 0) {
            JOptionPane.showMessageDialog(this, "Preço de compra invalido - digite valor+.+0.Ex; 10.0", "Alerta", JOptionPane.WARNING_MESSAGE);
            ftfPrecoCompra.requestFocus();
            return false;
        }
        if (((Double) ftfPrecoVenda.getValue()) <= 0) {
            JOptionPane.showMessageDialog(this, "Preço de venda invalido - digite valor+.+0.Ex; 10.0", "Alerta", JOptionPane.WARNING_MESSAGE);
