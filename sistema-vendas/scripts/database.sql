...
CREATE TABLE tb_alltables (
  tbcliente varchar(100) NOT NULL,
  tbfornecedor varchar(100) NOT NULL,
  c  varchar(100) NOT NULL,
  tbvenda varchar(100) NOT NULL,
  tbcompra varchar(100) NOT NULL,
  tbitemvenda varchar(100) NOT NULL,
  tbitemcompra varchar(100) NOT NULL,
  alltables varchar(100) NOT NULL);
